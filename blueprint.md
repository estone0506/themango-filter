# The Mango Filter (V2.0) - 더망고 마켓 삭제 및 필터 관리 도구 (재건축)
...
## 향후 계획 (Step 2 - 필터 기능 복원)
- [x] **필터 수집**: 기존 V1의 필터 수집 및 리스트 관리 기능 재도입 (필요 시).
    - 필터 누적 수집 기능 구현 (중복 방지).
    - 개별 필터 삭제 및 목록 초기화 기능 추가.
- [ ] **마켓 체크박스 동기화**: 팝업에서 마켓 선택 시 페이지 체크박스 연동 기능 복원.
