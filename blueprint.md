# The Mango Filter (V5.5.5) - 더망고 마켓 삭제 및 필터 관리 도구 (재건축)
...
- [x] **마켓 체크박스 동기화**: 팝업에서 마켓 선택 시 페이지 체크박스 연동 및 양방향 상태 동기화 완료.
    - **자동 마켓 선택**: 상품 업데이트 페이지(`admin_goods_update.php`) 진입 시 팝업에서 선택한 마켓 자동 체크 기능 추가.
- [x] **테스트 기능**: 특정 필터(`푸마운동화(소)`) 자동 수집 및 페이지 이동 프로세스 시뮬레이션 버튼 추가.
