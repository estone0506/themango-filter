# The Mango Filter (V5.6.5) - 더망고 마켓 삭제 및 필터 관리 도구 (재건축)
...
### **V5.6.5 (2026-02-20)**
- **UI 타이틀 및 브랜딩 변경:** 
    - 메인 제목을 '더망고 필터관리'로 변경.
    - 하단에 '마켓삭제 / 신규 수집 / 마켓 등록' 안내 문구 추가.
...
- [x] **마켓 체크박스 동기화**: 팝업에서 마켓 선택 시 페이지 체크박스 연동 및 양방향 상태 동기화 완료.
    ...
    - **최종 완료 및 종료**: 모든 작업이 완료되면 필터명과 함께 알림(`alert`)을 표시하고, 확인 시 브라우저 탭을 자동 종료하여 작업 마무리.
